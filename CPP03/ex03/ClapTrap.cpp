...
// Constructors
ClapTrap::ClapTrap(void): _name("default"), _hitPoints(_startHitPoints), _energyPoints(_startEnergyPoints), _attackDamage(_startAttackDamage)
{
...
{
	std::cout << "Named Constructor called for ClapTrap " << name << std::endl;
	this->logStatus();
}
